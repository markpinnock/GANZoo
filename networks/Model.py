...
from networks.Networks import (
    ProStyleGANDiscriminator,
    ProGANGenerator,
    StyleGANGenerator
)

from networks.DCGAN import DCGenerator, DCDiscriminator
...
""" Deep convolutional GAN 
    ...
    convolutional generative adversarial networks. arXiv preprint, 2015
...
class DCGAN(BaseGAN):
    ...
    def __init__(self, config):
        ...
        self.Generator = DCGenerator(config=config, name="Generator")
        self.Discriminator = DCDiscriminator(config=config, name="Discriminator")
    ...
    def discriminator_step(self, real_images):
        ...
        for idx in range(self.n_critic):
            ...
            with tf.GradientTape() as d_tape:
                ...
                # TODO: why does this cause function instantiation to have undefined input shape???
    ...
    def generator_step(self, mb_size):
        # Generator training
    ...
    def train_step(self, real_images):
        ...
        self.generator_step(real_images.shape[0])

#-------------------------------------------------------------------------
""" ProGAN
    Karras et al. Progressive growing of gans for improved quality,
    stability, and variation. arXiv preprint, 2017
    ...
    def discriminator_step(self, real_images, scale):
        ...
        for idx in range(self.n_critic):
            ...
            with tf.GradientTape() as d_tape:
                ...
                # Gradient penalty if indicated
                if self.loss_fn == "wasserstein-GP":
                    grad_penalty = gradient_penalty_scale(d_real_batch, d_fake_images, self.Discriminator, scale)
                    d_loss += 10 * grad_penalty
...
""" StyleGAN 
    ...
    adversarial networks. Proceedings of the IEEE/CVF Conference on
